 ...
 * creating DataStore object that pulls from the server the list of available
...
dradis.plugins.PluginManager = function(){
   ...
   */
  this.getUploadPluginsStore = function(){
    return uploadPluginsDS;
  }

  /*
   * To access the internal +upload+ plugins data store
   */
  this.getImportPluginsStore = function(){
    return importPluginsDS;
  }
