# This initializer check whether the config/first_login.txt file exists. If it 
...
# will create the config/first_login.txt file and this initializer will never be 
# processed again.
#
